...
<body>
		...
		<div class="row c_center">
			<div class="col-md-3" id="left_content">
				...
				<div class="c_center" id="person_info">
					<img src="http://q1.qlogo.cn/g?b=qq&nk=2069644011&s=640" height="130" width="130"
						alt="丢失了我的头像?" class="img-circle">
					<h4 class="text-muted">塑料玩具车~~</h4>
				...
				<div id="list">
					<table class="table table-hover c_center">
						...
						<tr>
							<td><a href="/Blog/login.jsp"><span class="glyphicon glyphicon-login"></span>
								&nbsp;&nbsp;管理员登录</a></td>
						</tr>
					</table>
				</div>
	...
	<div id="footer">
		<div>
			<a href="https://github.com/39worldbest"><img src="/Blog/img/github.png"width="20px" height="20px" class="img-circle">&nbsp;&nbsp;GitHub</a>
			&nbsp;|
			<a href="#">&nbsp;&nbsp;MyBlog</a>
			<br/>
			copyright © 2021
